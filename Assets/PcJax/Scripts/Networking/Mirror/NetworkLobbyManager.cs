...
namespace Mirror
{
    ...
    public class NetworkLobbyManager : NetworkManager
    {
        ...
        public bool SendReturnToLobby()
        {
            ...
            client.Send(UnityEngine.Networking.MsgType.LobbyReturnToLobby, msg);
            return true;
        }
        ...
        public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            if (numPlayersForConnection >= maxPlayersPerConnection)
            {
                ...
                conn.Send(UnityEngine.Networking.MsgType.LobbyAddPlayerFailed, errorMsg);
                return;
            }
        ...
        public override void ServerChangeScene(string sceneName)
        {
            if (sceneName == m_LobbyScene)
            {
                for (int i = 0; i < lobbySlots.Length; i++)
                {
                    ...
                    if (Utils.GetPlayerController(uv.connectionToClient, uv.playerControllerId, out playerController))
                    {
        ...
        void OnServerSceneLoadedMessage(NetworkMessage netMsg)
        {
            ...
            PlayerController lobbyController;
            if (!Utils.GetPlayerController(netMsg.conn, (short)s_SceneLoadedMessage.value, out lobbyController))
            {
        ...
        public override void OnStartServer()
        {
            ...
            NetworkServer.RegisterHandler(UnityEngine.Networking.MsgType.LobbyReadyToBegin, OnServerReadyToBeginMessage);
            NetworkServer.RegisterHandler(UnityEngine.Networking.MsgType.LobbySceneLoaded, OnServerSceneLoadedMessage);
            NetworkServer.RegisterHandler(UnityEngine.Networking.MsgType.LobbyReturnToLobby, OnServerReturnToLobbyMessage);
